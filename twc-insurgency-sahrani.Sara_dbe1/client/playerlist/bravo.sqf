...
_player14 = if(!isNil "p201")then{if(!isPlayer p201)then{"";}else{(name p201);};}else{"";};
_player15 = if(!isNil "p202")then{if(!isPlayer p202)then{"";}else{(name p202);};}else{"";};
_player16 = if(!isNil "p203")then{if(!isPlayer p203)then{"";}else{(name p203);};}else{"";};
_player17 = if(!isNil "p204")then{if(!isPlayer p204)then{"";}else{(name p204);};}else{"";};
_player18 = if(!isNil "p205")then{if(!isPlayer p205)then{"";}else{(name p205);};}else{"";};
_player19 = if(!isNil "p206")then{if(!isPlayer p206)then{"";}else{(name p206);};}else{"";};
_player20 = if(!isNil "p207")then{if(!isPlayer p207)then{"";}else{(name p207);};}else{"";};
_player21 = if(!isNil "p208")then{if(!isPlayer p208)then{"";}else{(name p208);};}else{"";};
_player22 = if(!isNil "p209")then{if(!isPlayer p209)then{"";}else{(name p209);};}else{"";};



g_playerlist = [ ["Bravo - US Army",
	[["Bravo Squad Leader", 
		[_player14, "Squad Leader"]], 
	["Fire Team 1",
		[_player15, "Fire Team Leader"], 
		[_player16, "Rifleman"], 
		[_player17, "Grenadier"], 
		[_player18, "Automatic Rifleman"]], 
	["Fire Team 2",
		[_player19, "Fire Team Leader"], 
		[_player20, "Automatic Rifleman"], 
		[_player21, "Marksman"], 
		[_player22, "Medic"]]
		]
	]				
