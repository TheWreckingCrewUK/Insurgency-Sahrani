...
this forceAddUniform "UK3CB_BAF_U_JumperUniform_MTP";
...
for "_i" from 1 to 2 do {this addItemToVest "UK3CB_BAF_556_30Rnd_T";};
this addBackpack "UK3CB_BAF_B_Bergen_MTP_Rifleman_L_D";
this addItemToBackpack "ACRE_PRC117F";
this addHeadgear "UK3CB_BAF_H_Mk7_Camo_C";
