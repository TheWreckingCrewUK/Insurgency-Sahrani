...
if (!isNil "P109" && {player == P109}) then {
    g_class = "BAF_SUPSL";
	g_group = "0";
	g_unit = "074";
	g_name = "Support Team Leader(BAF)";
	g_radio_channel = 1;
	g_radio = "ACRE_PRC343";
	["en"] call acre_api_fnc_babelSetSpokenLanguages;
	["en"] call acre_api_fnc_babelSetSpeakingLanguage;
	hint "You are the Support Leader. You and your squad are to assist the other squads.";
	//Ammo Spawner
	ammoCrateSpawner addAction ["Spawn Small UK Ammobox",
	{nul = [] execVM "client\player\boxes\smallCrateUK.sqf";},[],0,true,false,"",""];
	//Mortar Spawner
...
if (!isNil "P110" && {player == P110}) then {
    g_class = "BAF_SUPMRTR";
	g_group = "0";
	g_unit = "075";
	g_name = "Support Mortarman";
	g_radio_channel = 1;
	g_radio = "ACRE_PRC343";
	["en"] call acre_api_fnc_babelSetSpokenLanguages;
	["en"] call acre_api_fnc_babelSetSpeakingLanguage;
	hint "You are the Support Mortarman. You are to follow your SL and blow up some contact.";
	//Ammo Spawner
	ammoCrateSpawner addAction ["Spawn Mortar",
	{nul = [] execVM "client\player\boxes\smallMortar.sqf";},[],0,true,false,"",""];
	//M32 Spawner
...
if (!isNil "P111" && {player == P111}) then {
    g_class = "BAF_SUPASSTMRTR";
	g_group = "0";
	g_unit = "076";
	g_name = "Support Asst. Mortarman";
	g_radio_channel = 1;
	g_radio = "ACRE_PRC343";
	["en"] call acre_api_fnc_babelSetSpokenLanguages;
	["en"] call acre_api_fnc_babelSetSpeakingLanguage;
...
if (!isNil "P112" && {player == P112}) then {
    g_class = "BAF_SUPMG";
	g_group = "0";
	g_unit = "077";
	g_name = "Support Machine Gunner";
	g_radio_channel = 1;
	g_radio = "ACRE_PRC343";
	["en"] call acre_api_fnc_babelSetSpokenLanguages;
	["en"] call acre_api_fnc_babelSetSpeakingLanguage;
...
if (!isNil "P113" && {player == P113}) then {
    g_class = "BAF_SUPASSTMG";
	g_group = "0";
	g_unit = "078";
	g_name = "Support Machine Gunner";
	g_radio_channel = 1;
...
//SNA Infantry units P4xx
if (!isNil "P401" && {player == P401}) then {
    g_class = "SNA_SL";
	g_group = "1";
	g_unit = "121";
	g_name = "Charlie Section Lead (SNA)";
	g_radio = "ACRE_PRC152";
	g_radio_channel = 3;
	["en", "ru"] call acre_api_fnc_babelSetSpokenLanguages;
	["en", "ru"] call acre_api_fnc_babelSetSpeakingLanguage;
	hint "You are in Charlie. Make sure to bind your ACRE Cycle Babel Language so you can speak with player civilians";
};
...
if (!isNil "P502" && {player == P502}) then {
	...
	g_radio_channel = 5;
	g_radio = "ACRE_PRC343";
	["en"] call acre_api_f	nc_babelSetSpokenLanguages;
	["en"] call acre_api_fnc_babelSetSpeakingLanguage;
